...
POSTGRES_CONTAINER=nymphadora-api-postgres
POSTGRES_EXEC=docker exec --env PGPASSWORD=$(NYMPHADORAAPI_POSTGRES_PASSWORD) $(POSTGRES_CONTAINER) psql --username=$(NYMPHADORAAPI_POSTGRES_USERNAME) --host=$(NYMPHADORAAPI_POSTGRES_HOSTNAME) --port=$(NYMPHADORAAPI_POSTGRES_PORT)
